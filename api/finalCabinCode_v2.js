// api/finalCabinCode_v2.js
// Corrected pattern: modelCode-0-thicknessCode-1-1-0-0-width-height-extras
...
function generateCabinDetailCode(req) {
  ...
  const thicknessCode = GLASS_THICKNESS_CODES[req.glass_key] || "2"; // default 6mm
