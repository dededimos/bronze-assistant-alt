// api/finalCabinCode_v7.js
// VS 140×200 fume 8 mm, BronzeClean – σωστό pattern
...
export function generateCabinDetailCode(req) {
  ...
  const extrasCode =
    req.extras.length ? EXTRAS_CODES[req.extras[0]] || "nullexp" : "nullexp";
