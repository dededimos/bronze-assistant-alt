...
public partial class Constraints9SViewModel : ConstraintsViewModel<Constraints9S>
{
    ...
    public override void SetNewConstraints(CabinConstraints constraints)
    {
        ...
        constraintsObject = constraints as Constraints9S ?? throw new InvalidOperationException($"Provided Constraints where of type {constraints.GetType().Name} -- and not of the expected type : {nameof(Constraints9S)}");
