...
{
    public partial class ConstraintsV4ViewModel : ConstraintsViewModel<ConstraintsV4>
    {
        /// <summary>
        ...
        public override void SetNewConstraints(CabinConstraints constraints)
        {
            ...
            constraintsObject = constraints as ConstraintsV4 ?? throw new InvalidOperationException($"Provided Constraints where of type {constraints.GetType().Name} -- and not of the expected type : {nameof(ConstraintsV4)}");
