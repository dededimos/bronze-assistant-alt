...
{
    public partial class ConstraintsVAViewModel : ConstraintsViewModel<ConstraintsVA>
    {
        ...
        public override void SetNewConstraints(CabinConstraints constraints)
        {
            ...
            constraintsObject = constraints as ConstraintsVA ?? throw new InvalidOperationException($"Provided Constraints where of type {constraints.GetType().Name} -- and not of the expected type : {nameof(ConstraintsVA)}");
