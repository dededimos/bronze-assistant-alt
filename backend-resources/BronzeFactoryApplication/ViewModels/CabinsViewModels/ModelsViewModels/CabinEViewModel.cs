...
{
    public partial class CabinEViewModel : CabinViewModel<CabinE>
    {
        private readonly ConstraintsEViewModel constraints;
        public override ConstraintsEViewModel Constraints => constraints;

        private readonly PartsEViewModel parts;
        public override PartsEViewModel Parts => parts;
        ...
        public CabinEViewModel(ConstraintsEViewModel constraintsEVM, PartsEViewModel partsVM) 
        : base(constraintsEVM, partsVM)
        {
            constraints = constraintsEVM;
            parts = partsVM;
        }
#nullable disable
        public CabinEViewModel()
        {
...
#nullable enable
        public override void SetNewCabin(Cabin cabin)
        {
            ...
            cabinObject = cabin as CabinE ?? throw new InvalidOperationException($"Provided Cabin was of type {cabin.GetType().Name} -- and not of the expected type : {nameof(CabinE)}");            constraints.SetNewConstraints(cabin.Constraints);
