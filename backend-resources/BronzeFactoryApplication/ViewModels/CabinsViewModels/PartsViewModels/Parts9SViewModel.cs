...
public partial class Parts9SViewModel : PartsViewModel<Cabin9SParts>
{
    ...
    public Parts9SViewModel(ICabinMemoryRepository repo):base(repo)
    {
        this.repo = repo;
    }
    ...
    public override void SetNewPartsList(CabinPartsList partsList, CabinIdentifier identifier)
    {
        ...
        partsListObject = partsList as Cabin9SParts ?? throw new InvalidOperationException($"Provided Parts where of type {partsList.GetType().Name} -- and not of the expected type : {nameof(Cabin9SParts)}");
