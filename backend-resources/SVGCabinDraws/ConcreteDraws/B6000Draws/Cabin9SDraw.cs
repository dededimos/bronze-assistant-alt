...
{
    public class Cabin9SDraw : CabinDraw<Cabin9S>
    {
        ...
        public Cabin9SDraw(Cabin9S cabin) : base(cabin) { }
        ...
        protected override void InitilizeDraw()
        {
            ...
            //We do not use the inner Thickness View of the Magnet Profile here => although it would be correct , the Draw will not be Visibly pleasing as the L0 horizontal Profiles will overlap the wall aluminiums and will look bad in the draws
        ...
        /// <summary>
        /// Places all the Relevant Parts of the Cabin in Position
        /// </summary>
        protected override void PlaceParts()
        {
            ...
            //At (End of MagnetStrio , 0)
            MagnetAluminium.SetCenterOrStartX(MagnetStrip1.ShapeCenterX + MagnetStrip1.BoundingBoxLength / 2, CSCoordinate.Start);
            MagnetAluminium.SetCenterOrStartY(0, CSCoordinate.Start);
