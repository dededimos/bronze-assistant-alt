...
{
    public class CabinVSDraw : CabinDraw<CabinVS>
    {
        ...
        public CabinVSDraw(CabinVS cabin) : base(cabin) { }
        ...
        protected override void InitilizeDraw()
        {
            ...
            if (cabin.Parts.WallSideFixer is CabinSupport wallsupport)
            {
                WallSupportTop1 = DrawsFactory.HingeDraws.BuildGlassSupport(wallsupport);
                WallSupportBottom1 = DrawsFactory.HingeDraws.BuildGlassSupport(wallsupport);
            }
            ...
            {
                MagnetAluminium.LayerNo = 4;
            }
        }

        protected override void PlaceParts()
        {
            #region 1.Wall Fixing
            double stepLength = cabin.GetStepCut()?.StepLength ?? 0;
            double stepHeight = cabin.GetStepCut()?.StepHeight ?? 0;
            ...
            #region 2. Fixed and Sliding Glass
            ...
            if (StepWallArea != null)
            {
                ...
                StepWallArea.SetCenterOrStartY(fixedGlassEndY - stepHeight, CSCoordinate.Start);
            }

            #endregion

            #region Various Parts Area
            ...
            Fixed1LockRight.SetCenterOrStartX(fixedGlassEndX 
            ...
            {
                //At (EndX of Magnet Strip , Start Y of Sliding Glass)
