...
{
    public class FixedGlassVABuilder : GlassBuilderBase<CabinVA>
    {
#nullable disable

        public FixedGlassVABuilder(CabinVA cabin, GlassBuilderOptions options = null) : base(cabin, options) { }
        ...
        public override void SetDefaultGlassLength()
        {
            ...
            }//Else do nothing correction length = 0 ;
        ...
        /// <summary>
        /// Returns the Step Height of the Fixed Glass that can have a Step in a VA Structure
        /// </summary>
        /// <param name="cabin"></param>
        /// <returns>The Glasses step Height or zero if there is no step</returns>
        public static double GetStepGlassHeight(CabinVA cabin)
        {
            if (cabin.HasStep)
            {
        ...
        /// <summary>
        /// Returns the Step Length of the Fixed Glass that can have a Step in a VA Structure
        /// </summary>
        /// <param name="cabin"></param>
        /// <returns>The Glasses step Length or zero if there is no step</returns>
        public static double GetStepGlassLength(CabinVA cabin)
        {
            if (cabin.HasStep)
            {
