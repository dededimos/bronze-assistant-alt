...
{
    public class Constraints9S : CabinConstraints, ISlidingConstraints
    {
        ...
        public Constraints9S(Constraints9S constraints):base(constraints)
        {
        ...
        public override Constraints9S GetDeepClone()
        {
            return new Constraints9S(this);
        }
        /// <summary>
