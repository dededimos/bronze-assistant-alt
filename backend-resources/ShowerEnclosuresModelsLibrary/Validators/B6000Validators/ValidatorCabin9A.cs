...
{
    public class ValidatorCabin9A : BaseValidatorCabin<Cabin9A>
    {
        public ValidatorCabin9A(ValidationTypeEnum validationType = ValidationTypeEnum.ValidateAll) : base(validationType)
        {
