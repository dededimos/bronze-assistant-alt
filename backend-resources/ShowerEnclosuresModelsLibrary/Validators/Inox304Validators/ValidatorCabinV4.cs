...
{
    public class ValidatorCabinV4 : BaseValidatorCabin<CabinV4>
    {
        public ValidatorCabinV4(ValidationTypeEnum validationType = ValidationTypeEnum.ValidateAll) : base(validationType)
        {
