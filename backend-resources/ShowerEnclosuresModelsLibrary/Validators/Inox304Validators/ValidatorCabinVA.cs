...
{
    public class ValidatorCabinVA : BaseValidatorCabin<CabinVA>
    {
        public ValidatorCabinVA(ValidationTypeEnum validationType = ValidationTypeEnum.ValidateAll):base(validationType)
        {
